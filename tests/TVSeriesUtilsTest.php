...
class TVSeriesUtilsTest extends TestCase
{
    ...
    public function testParse_release()
    {
        ...
        $this->assertEquals(['season' => 0, 'episode' => 0, 'series' => 'Mannens unyttige verden'], TVSeriesUtils::parse_release('Mannens unyttige verden'));
        $this->assertEquals(['series'=>'Søsken', 'season'=>0, 'episode'=>0], TVSeriesUtils::parse_release('Søsken 720p HDTV H264 PHP'));
