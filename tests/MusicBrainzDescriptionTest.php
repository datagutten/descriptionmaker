...
class MusicBrainzDescriptionTest extends TestCase
{
    ...
    public function testCover_art()
    {
        ...
        $desc = $mb->build_description('5901a41f-0860-4d3e-917b-dc5f9e27adfb');
        $this->assertStringContainsString('http://coverartarchive.org/release/5901a41f-0860-4d3e-917b-dc5f9e27adfb/27661418054.jpg', $desc);
    }
